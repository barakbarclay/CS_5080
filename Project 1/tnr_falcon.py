...
def main():
    ...
    route = find_shortest_path(multiDiGraph, orig, dest)

    # Calculate the actual distance of the route found by NetworkX
    nx_distance = calculate_path_length(multiDiGraph, route)
...
def create_graph():
    ...
    multiDiGraph = ox.graph_from_place(place_name, network_type="drive")
